...
printUtil.log("%#FF202010s: %#FFFFFF5d%% (%#00FF00-s) %j", "Green", 382, "Strike-Through", { abc : 123 });
printUtil.log("\n%#00FF00bd %#00FF00bs %#00FFFFs%%", 47, "Hello", 96.455123.toFixed(2));
printUtil.log("\n%#00FF00bd %#00FF00bs %#00FFFF.2f%%", 47, "Hello", 96.455123);
printUtil.log("\n%#00FF00bd %#00FF00bs %#00FFFF0.3f%%", 47, "Hello", 96.455123);
